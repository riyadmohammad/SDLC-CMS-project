            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('user-management.user.add')}}" class="btn btn-info btn-sm"><i class="fas fa-stream"></i> Add User</a>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$p['name']}}</td>
                                    <td>{{$p['email']}}</td>
                                    <td>{{@$p['userRole']['role']['name']}}</td>
                                    <td width="30">@if($p['image'])<img src="{{asset('public/upload/image/'.$p['image'])}}" width="100px" height="40px">
                                    ...
                                    <td style="">
                                        <a href="{{ route('user-management.user.edit',$p->id) }}" class="btn btn-primary btn-flat btn-sm" data-type="image"><i class="fas fa-edit"></i></a> | <a class="delete btn btn-danger btn-flat btn-sm" data-route="{{route('user-management.user.delete')}}" data-id="{{ $p->id }}"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                @endif
